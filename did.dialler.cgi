...
<br />
<input type="button" name="sub2" value="Submit, results will be loaded below" onclick="javascript: document.ticketform.submit();"></input>
</form>
...
<iframe name="ticketprocessor" frameborder='0' class="if_inline" src="./ticketprocessor.cgi" width="100%" height="600">
